...
# ===========================================================================
HOST = "web3m-ss"   # shown as  web3m-ss@github  in the header

ROWS = [
    ("host",),
    ("kv", "Focus", "Machine Learning & Backend"),
    ("kv", "Based", "Thailand"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, C++, TypeScript, Lua"),
    ("kv", "Backend", "FastAPI, Bun, PostgreSQL"),
    ("kv", "AI / ML", "TensorFlow, Python"),
    ("kv", "Frontend", "React, HTML5"),
    ("gap",),
    ("sec", "Currently"),
    ("bul", "Building useful ML-powered systems"),
    ("bul", "Learning through open-source projects"),
]
